...
**Current:** [`PRD.md`](PRD.md) — **approved v0.4** (2026-06-15); implementation shipped through v1.2.0

| Doc | Purpose | Status |
|-----|---------|--------|
| [ROADMAP-v2.md](ROADMAP-v2.md) | **Forward plan** — OSS launch, gateway parity, enterprise scale | Active |
| [ROADMAP.md](ROADMAP.md) | v1 phase plan (A–E) | Shipped |
...
| [sources-integration.md](sources-integration.md) | Open APIs + Google for Lt-fetch | Queued (ROADMAP-v2 F5) |
| [Glossary](glossary.md) | L0–L6, Lt, terms | Living |
| [Plan review](PLAN-REVIEW.md) | Pre-implementation issue tracker — 18/18 resolved | Historical |
| [Competitive landscape](../discovery/04-competitive-landscape.md) | vs LiteLLM, Ollama, etc. (2026-06) | Superseded by ROADMAP-v2 research |
