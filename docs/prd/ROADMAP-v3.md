...
Still worth doing, **after** G1–G3: B2/B3 boundaries (#172), extension content script (#171), IdP-minted keys (#176), synonym verifier (#208), silent conflicted auto-merge (#200). Multi-window budgets (#174) shipped. These are product, not the OpenRouter gap.
