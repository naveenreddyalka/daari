...
| S3 Default pull = L3 + embed (`--minimal` skips) | [#258](https://github.com/naveenreddyalka/daari/issues/258) | in this PR |
| S4 Cursor `--tunnel --yes --daemonize` | [#259](https://github.com/naveenreddyalka/daari/issues/259) | in this PR |
