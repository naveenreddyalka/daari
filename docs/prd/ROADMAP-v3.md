...
| Slice | Issue | Status |
|-------|-------|--------|
| S1 `daari onboard --yes` (pip/brew, no clone) | [#256](https://github.com/naveenreddyalka/daari/issues/256) | shipped |
...
| S6 Windows/WSL first-run (honest docs) | [#261](https://github.com/naveenreddyalka/daari/issues/261) | shipped |
| S7 `daari onboard --serve` | [#268](https://github.com/naveenreddyalka/daari/issues/268) | in this PR |
